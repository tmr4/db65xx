...
* Defined symbols and registers (labeled `K`, `PC`, `A`, `X`, `Y`, `P`, `B`, `D` and, `SP`) can be used in the Watch pane, the Debug Console and expressions.  Individual status register flag labels are not recognized.
