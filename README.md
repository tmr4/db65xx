...
4. Instructions `BBR0-7` and `BBS0-7` are not yet supported on the `65C02` core.  Unknown opcodes on the 65C02 and 6502 are simply skipped by incrementing the program counter.  Since this indicates that an error has occured I may pause execution in a future update.
